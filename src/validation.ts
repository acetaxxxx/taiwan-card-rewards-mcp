...
export function validatePaymentRouteRecord(value: unknown): PaymentRouteRecord {
  ...
  keys(item, ['id', 'status', 'layers', 'funding', 'sourceUrl', 'sourceSnapshotId', 'contentHash', 'observedAt', 'validFrom', 'validTo', 'authority', 'confidence', 'confirmation', 'evidenceIds', 'idempotencyKey', 'ownerUser'], 'payment route');
