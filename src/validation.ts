...
function validateIngestionFlow(value: unknown): IngestionFlowRecord {
  ...
  keys(item, ['id', 'ownerUser', 'sourceScope', 'revision', 'status', 'idempotencyKey', 'createdAt', 'lastActivityAt', 'expiresAt', 'sourceCapture', 'manifest'], 'ingestion flow');
