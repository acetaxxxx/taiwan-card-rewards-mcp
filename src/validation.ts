...
export function validatePaymentCapability(value: unknown): PaymentCapabilityRecord {
  ...
  keys(item, ['id', 'status', 'providerId', 'acceptanceProviderId', 'consumerAppId', 'merchant', 'market', 'channel', 'fundingKinds', 'sourceUrl', 'evidenceIds', 'observedAt', 'validFrom', 'validTo', 'idempotencyKey', 'ownerUser'], 'payment capability');
