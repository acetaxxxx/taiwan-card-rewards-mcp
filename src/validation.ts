...
export function validateFxPolicy(value: unknown): FxPolicyRecord {
  ...
  keys(item, ['id', 'policyKey', 'version', 'baseCurrency', 'quoteCurrency', 'scope', 'conversionOwner', 'rateType', 'rateDirection', 'conversionTiming', 'feeBasis', 'markupBasis', 'sourceUrl', 'evidenceId', 'observedAt', 'validFrom', 'validTo', 'idempotencyKey', 'ownerUser'], 'fx policy');
