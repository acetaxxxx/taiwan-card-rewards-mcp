...
export const mcpTools: readonly McpToolContract[] = [
  ...
  { name: 'upsert_offer', description: 'Store a public offer source snapshot and its versioned rule.', readOnly: false, inputSchema: { type: 'object', required: ['snapshot', 'rule'] }, failClosedErrors: ['INVALID_OFFER', 'STORE_UNAVAILABLE'] },
