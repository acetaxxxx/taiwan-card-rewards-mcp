...
- [Copyable AI-assisted installation](../INSTALL_WITH_AI.md)
...
- [Low-reasoning playbook for Gemini Flash and Luna](agents/taiwan-card-rewards-skill/references/low-reasoning-playbook.md)
- [使用者安裝與 Skill 分發 SOP](agents/user-installation-and-skill-distribution-sop.md)
- [Agent Research Skill 與 Pre-flight SOP](agents/agent-research-skill-and-preflight-sop.md)
