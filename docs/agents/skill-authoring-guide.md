...
2. Confirm all 25 canonical public tools exist, including `recommendation_preflight`, payment-path recommendation, and payment-route/account onboarding/listing, with the expected closed input schemas;
