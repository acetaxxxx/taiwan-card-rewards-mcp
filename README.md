...
- **Users installing the MCP and runtime skill:** copy the instruction in [`INSTALL_WITH_AI.md`](INSTALL_WITH_AI.md) into an AI coding agent after filling in the three requested paths.
- **Runtime agents serving card-rewards users:** install the complete [`docs/agents/taiwan-card-rewards-skill/`](docs/agents/taiwan-card-rewards-skill/) bundle. Its `SKILL.md`, references, workflows, examples, and templates are one installation unit.
...
- `INSTALL_WITH_AI.md` — copyable instructions for an AI agent to install the MCP configuration and complete runtime skill bundle
