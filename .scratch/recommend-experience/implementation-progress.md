...
| 07 | In progress | Separate typed capability persistence, explicit transition requirements, ephemeral wallet/account route generation, and capability-scoped binding actions are covered; full candidate coverage remains |
