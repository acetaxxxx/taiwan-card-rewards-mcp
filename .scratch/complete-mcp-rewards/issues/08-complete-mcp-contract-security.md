...
**What to build:** The complete nine-tool stdio MCP surface provides stable structured outcomes for calculation, source governance, card management, recommendations, ledger operations, and cap inspection under strict identity, input, and public-fetch boundaries.
...
- [x] All nine tools are exposed with stable schemas and structured success, uncertainty, stale, needs-review, and rejection errors.
